...
s0_initiate_all_button = <TopEdge>Button2
...
[winrules]
s0_skiptaskbar_match = type=Desktop | class=Cairo-dock
s0_skippager_match = 
s0_above_match = 
s0_below_match = 
s0_sticky_match = 
...
[core]
s0_active_plugins = core;composite;crashhandler;opengl;copytex;compiztoolbox;decor;move;regex;put;vpswitch;matecompat;resize;wall;animation;workspacenames;annotate;workarounds;mousepoll;grid;commands;imgpng;place;winrules;shift;screenshot;obs;showmouse;wobbly;session;expo;fade;scale;ezoom;switcher;scaleaddon;
...
s0_opacity_step = 5
s0_opacity_matches = Tooltip | Menu | PopupMenu | DropdownMenu;name=mate-panel;
...
[animation]
s0_open_effects = animation:Sidekick;animation:Fade;animation:Fade;
s0_open_durations = 500;80;80;
s0_open_matches = ((type=Normal | Unknown) | name=sun-awt-X11-XFramePeer | name=sun-awt-X11-XDialogPeer) & !(role=toolTipTip | role=qtooltip_label) & !(type=Normal & override_redirect=1) & !(name=gnome-screensaver) & !(name=guake);((type=Menu | PopupMenu | DropdownMenu | Combo | Dialog | ModalDialog | Normal) & !(class=\.exe$));(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd);
s0_open_options = ;;;
s0_open_random_effects = 
s0_close_effects = animation:Sidekick;animation:Fade;animation:Fade;
s0_close_durations = 500;80;50;
s0_close_matches = ((type=Normal | Unknown) | name=sun-awt-X11-XFramePeer | name=sun-awt-X11-XDialogPeer) & !(role=toolTipTip | role=qtooltip_label) & !(type=Normal & override_redirect=1) & !(name=gnome-screensaver) & !(name=gnome-screenshot) & !(name=guake;((type=Menu | PopupMenu | DropdownMenu | Combo | Dialog | ModalDialog | Normal) & !(class=\.exe$));(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd);
s0_close_options = ;;;
...
s0_sidekick_num_rotations = 2.000000
s0_sidekick_springiness = 0.300000
